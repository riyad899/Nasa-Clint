      ...
      <div className="mx-auto flex h-[76px] max-w-7xl items-center justify-between px-5 sm:px-8">
        ...
        <nav className="hidden items-center gap-9 md:flex">
          {links.map((l, i) => (
            ...
            >
              ...
              {i === 0 && (
                <span className="absolute -bottom-[26px] left-0 h-[2px] w-full bg-primary-700" />
              )}
            </Link>
          ))}
        </nav>
        ...
        <div className="hidden items-center gap-3 md:flex">
          ...
          {user ? (
            ...
            <Link
              href="/signin"
              className="rounded-full bg-primary-800 px-4 py-2 text-sm font-semibold text-white hover:bg-primary-900"
            >
              Sign In
            </Link>
          )}
          ...
          {user ? (
            <div className="mt-3 space-y-2 border-t border-primary-100 pt-3">
              ...
              <Link
                href="/dashboard"
                onClick={() => setOpen(false)}
                className="block rounded-full bg-primary-700 py-2.5 text-center text-sm font-semibold text-white"
              >
                Go to Dashboard
              </Link>
            ...
            <Link
              href="/signin"
              onClick={() => setOpen(false)}
              className="mt-3 flex items-center justify-center gap-2 rounded-full bg-primary-700 py-2.5 text-sm font-semibold text-white"
            >
              Sign In
            </Link>
          )}
